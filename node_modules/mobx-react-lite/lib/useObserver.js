...
// BC
var globalStateVersionIsAvailable = typeof (0, mobx_1._getGlobalState)().stateVersion !== "undefined";
...
function useObserver(render, baseComponentName) {
    ...
    var _a = __read(react_1.default.useState(), 2), forceUpdate = _a[1];
    if (!admRef.current) {
        // First render
        var adm_1 = {
            reaction: null,
            ...
            getSnapshot: function () {
                ...
                return globalStateVersionIsAvailable
                    ? (0, mobx_1._getGlobalState)().stateVersion
                    : adm_1.stateVersion;
            }
        };
